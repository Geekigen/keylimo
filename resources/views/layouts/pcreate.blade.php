...
@section('content')
<div class="card">
    <div class="card-header">{{__('Sell item')}}</div>
    ...
    <div class="card-body">
        <form method="POST" action="/products"  enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="location" type="text" class="form-control @error('price') is-invalid @enderror" name="location" value="{{ old('location') }}" required autocomplete="location" autofocus>
